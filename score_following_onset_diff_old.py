...
# NEWFILE = os.path.join(DIRECTORY,'generated_{}filter3.mid'.format(FILTER))
# CONF_FILE = os.path.join(DIRECTORY,'{}filter_confidence3.txt'.format(FILTER))
# TEMPO_FILE = os.path.join(DIRECTORY,'tempo.txt')
# Rc =  int(open(TEMPO_FILE, "r").readline().strip('\n'))
# 70 is for shuo san jiu san
# Rc = 70
